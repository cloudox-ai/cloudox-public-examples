...
This appendix provides a stable mapping between the friendly names used throughout this view and the underlying raw identifiers, enabling traceability back to the cloud environment.
...
> **Confidence note:** The Log Archive Account (`122980216815`) is rated **Likely** — its role has been inferred but not fully confirmed. Treat references to it with appropriate caution.
...
No evidence references are available for this section. The entity mappings above are derived from CloudoX discovery data; consult the relevant thematic sections of this view for the intelligence items and evidence that informed each finding.
